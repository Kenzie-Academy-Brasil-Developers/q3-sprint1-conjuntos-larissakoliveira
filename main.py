...
def popular_only_spanish_fruits(popular_fruits, spanish_fruits, japanese_fruits, brazilian_fruits):
    second_part = spanish_fruits.difference(japanese_fruits.union(brazilian_fruits))
    output = popular_fruits.intersection(second_part)
    return list(output)

print(popular_only_spanish_fruits(popular_fruits, spanish_fruits, japanese_fruits, brazilian_fruits))
...
print(only_hotmail_emails(emails))
